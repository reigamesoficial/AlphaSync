...
import { CalendarDays, ClipboardList, Zap, ChevronRight, LogOut } from 'lucide-react'
        ...
        <div className="h-16 flex items-center px-5 border-b border-surface-600">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[10px] text-emerald-400 leading-none">Instalador</p>
            </div>
          </div>
        </div>
          ...
          {nav.map(({ to, label, icon: Icon }) => {
            ...
            return (
              ...
              >
                ...
                {active && <ChevronRight className="w-3 h-3 text-emerald-500 opacity-70" />}
              </NavLink>
            )
          })}
        </nav>
        ...
        <div className="p-3 border-t border-surface-600">
          <div className="card p-3">
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-full bg-emerald-600/30 flex items-center justify-center text-emerald-400 text-xs font-bold shrink-0">
                {initials}
              </div>
